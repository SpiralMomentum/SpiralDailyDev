...
class WorldMapView extends StatelessWidget {
  const WorldMapView({super.key, required this.data});

  final WorldMapData data;

  void _openCountryDetail(
    BuildContext context, {
    required String countryId,
    required String? countryName,
  }) {
    final instruction = getInstructions(countryId);
            ...
            child: ClipRRect(
              ...
              child: InteractiveViewer(
                ...
                child: SimpleMap(
                  ...
                  callback: (selectedCountryId, selectedCountryName, ___) {
                    _openCountryDetail(
                      context,
