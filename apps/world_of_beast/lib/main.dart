...
import 'data/datasources/favorite_monsters_local_data_source.dart';
import 'data/datasources/monsters_local_data_source.dart';
import 'data/repositories/favorite_monsters_repository_impl.dart';
...
import 'presentation/viewmodels/monster_favorites_controller.dart';
...
class _WorldOfBeastsHomePageState extends State<WorldOfBeastsHomePage> {
  ...
  void initState() {
    ...
    final favoriteRepository = FavoriteMonstersRepositoryImpl(
