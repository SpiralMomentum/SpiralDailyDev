    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: ThemeData(brightness: Brightness.light).textTheme.apply(
          bodyColor: _LuckColors.textPrimary,
          displayColor: _LuckColors.textPrimary,
        ),
        useMaterial3: true,
      ),
        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _LuckColors.accentBorder),
              boxShadow: [
                BoxShadow(
                  color: _LuckColors.softShadow,
  ...
  void _showHistory() {
    if (_historyRank1.isEmpty) {
      showModalBottomSheet<void>(
        ...
        backgroundColor: _LuckColors.card,
...
class _LuckColors {
  ...
  static const textPrimary = Color(0xFF3C2D25);
  static const accentBorder = Color.fromARGB(38, 255, 140, 50);
  static const accentFill = Color.fromARGB(41, 255, 140, 50);
  static const textSecondary = Color.fromARGB(153, 60, 45, 37);
  static const softShadow = Color.fromARGB(10, 0, 0, 0);
}
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.labelSmall?.copyWith(color: _LuckColors.textSecondary),
        ),
      ],
    );
  }
          ...
          children: [
            ...
            Text(
              ...
              style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                color: _LuckColors.textSecondary,
              ),
            ),
            const SizedBox(height: 36),
          ],
